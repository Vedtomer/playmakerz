  ...
  return (
    <>
      ...
      >
        ...
        />
        <Reveal className="relative mx-auto max-w-7xl px-6 py-28">
      ...
      <section id="pcl" className="bg-black text-white scroll-mt-24">
        <Reveal className="mx-auto max-w-7xl px-6 py-20 grid gap-10 lg:grid-cols-2 items-center">
